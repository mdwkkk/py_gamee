...
WAYPOINTS = [(0, 100), (200, 100), (200, 460), (600, 460), (600, 300), (800, 300)]
...
class Bullet(pygame.sprite.Sprite):
    ...
    def update(self, dt):
        ...
        if not (
            0 <= self.rect.x <= WIDTH and 0 <= self.rect.y <= HEIGHT
...
class OutpostDefenseGame:
    def __init__(self):
        ...
        self.terrain_tile = pygame.transform.scale(
            orig_terrain_img, (TILE_SIZE, TILE_SIZE)
        )
        ...
        self.outpost_rect = self.outpost_img.get_rect(center=WAYPOINTS[-1])
    ...
    def draw_ui(self):
        ...
        hp_surface = self.ui_font.render(
            hp_text, True, (255, 50, 50) if self.base_hp <= 30 else COLOR_TEXT
        )
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
                ...
                if self.credits >= self.turret_cost:
                    ...
                    if temp_rect.collidepoint(WAYPOINTS[-1]):
                        is_on_path = True
